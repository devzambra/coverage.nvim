...
function M.setup()
	...
	vim.api.nvim_create_autocmd("BufEnter", {
		...
		callback = function()
			vim.cmd("silent! lua require('coverage').apply_coverage_highlights()")
		end,
	})
	...
	vim.api.nvim_create_user_command("CoverageRefresh", function()
		require("coverage").apply_coverage_highlights()
	end, {})

	vim.keymap.set("n", "<leader>tcs", function()
		require("coverage").show_coverage_summary()
	...
	vim.keymap.set("n", "<leader>tct", function()
		require("coverage").toggle_coverage_highlights()
